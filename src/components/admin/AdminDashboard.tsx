...
import { BrevoSmtpModal } from './BrevoSmtpModal';
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [isBrevoModalOpen, setIsBrevoModalOpen] = useState<boolean>(false);
  ...
  return (
    <div className="min-h-screen bg-neutral-50/70 pb-24 pt-6">
            ...
            <div className="space-y-3 text-xs text-neutral-700">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-neutral-50/70 border border-neutral-200/80">
                ...
                <button
                  ...
                  className="rounded-xl bg-neutral-900 hover:bg-neutral-800 text-[#FED000] px-3.5 py-2 text-xs font-semibold cursor-pointer transition-colors shadow-xs"
                >
                  Configure &amp; Test
                </button>
              </div>
      ...
      {/* Brevo SMTP Diagnostics & Test Modal */}
      <BrevoSmtpModal
